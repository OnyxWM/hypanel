...
export class PlayerTracker extends EventEmitter {
     ...
     */
    removePlayer(serverId, playerName) {
        if (!serverId || !playerName) {
            return;
        }
     ...
     */
    updatePlayersFromList(serverId, playerNames) {
        if (!serverId) {
            return;
        }
...
// Singleton instance
let playerTrackerInstance = null;
